...
startfile_out = directory + "/NEB LAMMPS input files/aSiInputs/" + "neb_input_" + file_appendix + ".out"
finalfile = directory + "/" + final_filename
finalfile_out = directory + "/NEB LAMMPS input files/aSiInputs/" + "neb_end_" + file_appendix + ".out"
startatoms = {}
finalatoms = {}
count = 0
nebatoms = []
...
nebatomsfile = directory + "/NEB LAMMPS input files/aSiInputs/" + nebatom_filename
