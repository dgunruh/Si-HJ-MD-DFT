...
mpirun -np 6 ~/lammps-3Mar20/parallel_build/lmp_mpi -var s $s -var d $dumpA -var ds $dumpsnapA -in createAmorphousSiGAP.in
# mpirun -np 4 ./lmp_mpi -var s $s -var d $dumpA -var ds $dumpsnapA -in createAmorphousSi.in
